...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <header className="bg-card border-b border-border px-8 py-5 text-center">
        <h1 className="text-[28px] font-semibold text-foreground leading-tight">
          BA Research operations
        </h1>
      ...
      <main className="flex-1 px-8 py-6 flex flex-col items-center">
        <div className="w-full max-w-7xl">
          <div className="flex justify-center mb-6">
            <div className="bg-card border border-border rounded-lg shadow-xs inline-flex flex-wrap p-1 gap-1">
              {REGIONS.map((region) => (
                <button
                  type="button"
                  key={region}
