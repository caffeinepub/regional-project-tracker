...
export class Backend implements backendInterface {
    ...
    async getEditHistory(arg0: bigint, arg1: string): Promise<Array<EditEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEditHistory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProjectEditHistory(arg0: bigint): Promise<Array<EditEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectEditHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProjectsByRegion(arg0: string): Promise<Array<Project>> {
        if (this.processError) {
            try {
    ...
    async updateProjectField(arg0: bigint, arg1: string, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProjectField(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
